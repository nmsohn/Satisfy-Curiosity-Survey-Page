...
/* harmony import */ var styled_jsx_server__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! styled-jsx/server */ "styled-jsx/server");
...
class MyDocument extends next_document__WEBPACK_IMPORTED_MODULE_9___default.a {
  static async getInitialProps(ctx) {
    ...
    const sheet = new styled_components__WEBPACK_IMPORTED_MODULE_11__["ServerStyleSheet"]();
    ...
    try {
      ...
      return _objectSpread({}, initialProps, {
        styles: __jsx(react__WEBPACK_IMPORTED_MODULE_8___default.a.Fragment, null, initialProps.styles, sheet.getStyleElement())
      });
    } finally {
      sheet.seal();
    }
  ...
  render() {
    return __jsx("html", {
      ...
      name: "keywords",
      content: "jobs,nz,odd jobs,errands,temp jobs, one off jobs",
      __source: {
        fileName: _jsxFileName,
        lineNumber: 45
      },
